...
admin = [1178979444] #ID админа
support_name = '@raz1mov' #Имя саппорта, будет выводиться при нажатии кнопки "поддержка"
token = '8742929536:AAFKYfsIFaAd0Po_Ipv-prdHAeSuYgl_qBU' #Токен бота
